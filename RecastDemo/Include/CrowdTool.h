...
class CrowdToolState : public SampleToolState
{
	...
	static const int AGENT_MAX_TRAIL = 64;		//最大的路径64步
	static const int MAX_AGENTS = 128;			//最多角色数量128
	struct AgentTrail
	{
...
class CrowdTool : public SampleTool
{
	...
	enum ToolMode
	{
		TOOLMODE_CREATE,					//创建角色
		TOOLMODE_MOVE_TARGET,				//设置目标点
		TOOLMODE_SELECT,					//选择角色
		TOOLMODE_TOGGLE_POLYS,				//抠除某个鼠标点击的多边形区域
	};
	ToolMode m_mode;
