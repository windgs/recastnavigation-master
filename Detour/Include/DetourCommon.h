...
/// Performs a scaled vector addition. (@p v1 + (@p v2 * @p s))-执行比例向量加法
...
/// 导出三角形ab c的有符号xz平面面积，或直线ab与点c的关系
